...
if __name__ == "__main__":
    # load configuration
    with open("../configs/SCAFFOLD.yaml", 'r') as f:
    ...
    for client_id in range(args["client_num"]):
        client = SCAFFOLDClient(client_id, args, client_train_set[client_id], client_test_set[client_id], 0)
    ...
    for _round in range(args["rounds"]):
        ...
        server.update_global_c(selected_clients)
        server.send_params(selected_clients)
