...
from entities.FedBABU import FedBABUClient, FedBABUServer
from utils.gen_dataset import distribute_dataset

if __name__ == "__main__":
    # read training parameters
    with open("../configs/FedBABU.yaml", 'r') as f:
    ...
    for client_id in range(args["client_num"]):
        client = FedBABUClient(client_id, args, client_train_set[client_id], client_test_set[client_id], 0)
        clients.append(client)

    server = FedBABUServer(args)
