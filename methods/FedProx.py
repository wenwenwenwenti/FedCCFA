...
if __name__ == "__main__":
    ...
    for client_id in range(args["client_num"]):
        client = FedProxClient(client_id, args, client_train_set[client_id], client_test_set[client_id], 0)
        clients.append(client)

    server = FedProxServer(args)
